 ...
 */
        ...
        /* No of Scheduling Queues changed to 19 to include extra 3 queues */
        #define NR_SCHED_QUEUES 19                                                                  /* #define NR_SCHED_QUEUES   16	/* MUST equal minimum priority + 1 */

    #define TASK_Q		   0	/* highest, used for kernel tasks */

        /* Normally zero but here we want user queue to stay between 16 to 19*/
